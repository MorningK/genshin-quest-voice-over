...
from genshin_voice_over.app.bootstrap import (
    DPI_AWARENESS_SYSTEM,
    DPI_AWARENESS_UNAWARE,
    read_dpi_awareness,
)
from genshin_voice_over.common import MonitorTarget, Point, Region, SelectedRegion
...
def _scale_factor_for(awareness: int, monitor_scale: float, primary_scale: float) -> float:
    ...
    Args:
        awareness: 进程 DPI 感知模式（取值见 ``genshin_voice_over.app.bootstrap`` 中的常量）。
